  ...
  context "with a valid file" do
    context "without a sort order" do
      it "outputs all the records, unsorted" do
        ...
        Application.new([csv_file])
      end
    end

    context "gender sort order" do
      it "outputs all the records sorted by gender" do
        ...
        Application.new([csv_file, "gender"])
      end
    end

    context "birthdate sort order" do
      it "outputs all the records sorted by birthdate" do
        ...
        Application.new([csv_file, "birthdate"])
      end
    end
    ...
    context "lastname sort order" do
      it "outputs all the records sorted by birthdate" do
        ...
        Application.new([csv_file, "lastname"])
      end
    end
  end
end
